...
module IconCatalog {
    ...
    function labelFor(iconId) {
        switch (iconId) {
            case ICON_PLAY:         return "run";
            case ICON_PENCIL:       return "edit";
            case ICON_EYE:          return "read";
            case ICON_GLOBE:        return "web";
            case ICON_CLIPBOARD:    return "todo";
            case ICON_WRENCH:       return "tool";
            case ICON_CHECK:        return "ok";
            case ICON_GREEN_CIRCLE: return "start";
            case ICON_PAUSE:        return "idle";
            case ICON_STOP:         return "stop";
            case ICON_WARNING:      return "err";
            case ICON_QUESTION:     return "ask";
            case ICON_NO_ENTRY:     return "deny";
            case ICON_STATUS_DOT:   return "info";
        }
        return "";
    }
    ...
    function statusGlyphFor(iconId, flags) {
        switch (iconId) {
            case ICON_CHECK:        return "+";
            case ICON_GREEN_CIRCLE: return "+";
            case ICON_WARNING:      return "!";
            case ICON_NO_ENTRY:     return "x";
            case ICON_QUESTION:     return "?";
            case ICON_PAUSE:        return "~";
            case ICON_STOP:         return "x";
            case ICON_STATUS_DOT:   return ".";
        }
        // FLAG_ACCENT without a known icon falls back to "!"
        if (flags != null && ((flags as Lang.Number) & HistoryDecoder.FLAG_ACCENT) != 0) {
            return "!";
        }
        return "-";
    }
    ...
    function statusColorFor(iconId, flags) {
        ...
        switch (iconId) {
            case ICON_CHECK:        return Palette.done();
            case ICON_GREEN_CIRCLE: return Palette.done();
            case ICON_WARNING:      return Palette.active();
            case ICON_NO_ENTRY:     return Palette.active();
            case ICON_QUESTION:     return Palette.active();
            case ICON_PAUSE:        return Palette.chrome();
            case ICON_STOP:         return Palette.chrome();
        }
        return Palette.text();
    }
    ...
    function glyphBitmapIndex(iconId, flags) {
        switch (iconId) {
            case ICON_CHECK:        return StatusModel.GLYPH_PLUS_GREEN;
            case ICON_GREEN_CIRCLE: return StatusModel.GLYPH_PLUS_GREEN;
            case ICON_WARNING:      return StatusModel.GLYPH_BANG_AMBER;
            case ICON_NO_ENTRY:     return StatusModel.GLYPH_X_AMBER;
            case ICON_QUESTION:     return StatusModel.GLYPH_QUESTION_AMBER;
            case ICON_PAUSE:        return StatusModel.GLYPH_TILDE_CHROME;
            case ICON_STOP:         return StatusModel.GLYPH_X_CHROME;
            case ICON_STATUS_DOT:   return StatusModel.GLYPH_DOT_WHITE;
        }
